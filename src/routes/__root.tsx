...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Truegauge AI — AI Automation Consultancy" },
      {
        name: "description",
        content:
          "Truegauge AI helps South African businesses implement measurable AI automation and workflow systems.",
      },
      { name: "author", content: "Truegauge AI" },
